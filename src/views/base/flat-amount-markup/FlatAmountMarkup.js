...
function FlatAmountMarkup() {
  return (
    <>
      <title>XeniApp : Flat amount of Markup</title>
        ...
        <div id="main" className="aui-page-panel">
          <div id="main-header">
            ...
            <h1 id="title-heading" className="pagetitle">
              <span id="title-text">XeniApp : Flat amount of Markup</span>
            </h1>
          </div>
          <div id="content" className="view">
            <div className="page-metadata">
              Created by <span className="author"> Gerardo Nizetich</span> on Dec 06, 2023
            </div>
            <div id="main-content" className="wiki-content group">
              <hr />
              <h1 id="FlatamountofMarkup-Objective">Objective</h1>
              <p>
                Allow Travel Agency owners and administrators to configure flat amounts for each
                type of product in the Xeni platform.
              </p>
              <hr />
              <p></p>
              <div className="plugin_pagetree">
                ...
                <fieldset className="hidden">
                  ...
                  />
                  <input type="hidden" name="treePageId" defaultValue={592379968} />
                  <input type="hidden" name="noRoot" defaultValue="false" />
                  <input type="hidden" name="rootPageId" defaultValue={592379968} />
                  ...
                  <fieldset className="hidden">
                    <input type="hidden" name="ancestorId" defaultValue={592379968} />
                  </fieldset>
                </fieldset>
              </div>
              <p />
...
export default FlatAmountMarkup
