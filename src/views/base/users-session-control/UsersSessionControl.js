...
function UsersSessionControl() {
  return (
    <>
      <title>XeniApp : Users Session Control</title>
        ...
        <div id="main" className="aui-page-panel">
          <div id="main-header">
            ...
            <h1 id="title-heading" className="pagetitle">
              <span id="title-text">XeniApp : Users Session Control</span>
            </h1>
          </div>
            ...
            <div id="main-content" className="wiki-content group">
              ...
              <div className="plugin_pagetree">
                ...
                <fieldset className="hidden">
                  ...
                  />
                  <input type="hidden" name="treePageId" defaultValue={591298781} />
                  <input type="hidden" name="noRoot" defaultValue="false" />
                  <input type="hidden" name="rootPageId" defaultValue={591298781} />
                  ...
                  <fieldset className="hidden">
                    <input type="hidden" name="ancestorId" defaultValue={591298781} />
                  </fieldset>
                </fieldset>
              </div>
              <p />
...
export default UsersSessionControl
