...
function SplitPayment() {
  return (
    <>
      <title>XeniApp : Split payment</title>
        ...
        <div id="main" className="aui-page-panel">
          <div id="main-header">
            ...
            <h1 id="title-heading" className="pagetitle">
              <span id="title-text">XeniApp : Split payment</span>
            </h1>
          </div>
          <div id="content" className="view">
            ...
            <div id="main-content" className="wiki-content group">
              <hr />
              <h1 id="Splitpayment-Objective">Objective</h1>
              <p>
                Reduce the cost per transaction driving the flight services to the validating
                airline merchant id, and the rest of the services through Xeni´s merchant id.{' '}
              </p>
              <hr />
              <p></p>
              <div className="plugin_pagetree">
                ...
                <fieldset className="hidden">
                  ...
                  />
                  <input type="hidden" name="treePageId" defaultValue={585728003} />
                  <input type="hidden" name="noRoot" defaultValue="false" />
                  <input type="hidden" name="rootPageId" defaultValue={585728003} />
                  ...
                  <fieldset className="hidden">
                    <input type="hidden" name="ancestorId" defaultValue={585728003} />
                  </fieldset>
                </fieldset>
              </div>
              <p />
