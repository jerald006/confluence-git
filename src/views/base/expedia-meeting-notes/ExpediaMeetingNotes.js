...
function ExpediaMeetingNotes() {
  return (
    <>
      <title>XeniApp : Expedia Meeting Notes</title>
        ...
        <div id="main" className="aui-page-panel">
          <div id="main-header">
            ...
            <h1 id="title-heading" className="pagetitle">
              <span id="title-text">XeniApp : Expedia Meeting Notes</span>
            </h1>
          </div>
          <div id="content" className="view">
            <div className="page-metadata">
              Created by <span className="author"> Gerardo Nizetich</span> on Dec 27, 2023
            </div>
...
export default ExpediaMeetingNotes
