...
function FRDRciIntegrationBookingCheckout() {
  return (
    <>
      <title>XeniApp : FRD - RCI Integration - MVP1 - Booking and checkout</title>
        ...
        <div id="main" className="aui-page-panel">
          <div id="main-header">
            ...
            <h1 id="title-heading" className="pagetitle">
              <span id="title-text">
                XeniApp : FRD - RCI Integration - MVP1 - Booking and checkout
              </span>
            </h1>
          </div>
          <div id="content" className="view">
            ...
            <div id="main-content" className="wiki-content group"></div>
          </div>{' '}
        </div>
...
export default FRDRciIntegrationBookingCheckout
