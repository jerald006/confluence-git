        ...
        <div id="main" className="aui-page-panel">
          <div id="main-header">
            ...
            <h1 id="title-heading" className="pagetitle">
              <span id="title-text">XeniApp : Seat map</span>
            </h1>
          </div>
            ...
            <div id="main-content" className="wiki-content group">
              <style
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    '/*<![CDATA[*/\ndiv.rbtoc1719206651152 {padding: 0px;}\ndiv.rbtoc1719206651152 ul {list-style: disc;margin-left: 0px;}\ndiv.rbtoc1719206651152 li {margin-left: 0px;padding-left: 0px;}\n\n/*]]>*/',
                }}
              />
              <div className="toc-macro rbtoc1719206651152">
                <ul className="toc-indentation">
                  <li>
                    <a href="#Seatmap-Objective">Objective</a>
                  </li>
                </ul>
              </div>
              <hr />
              <h1 id="Seatmap-Objective">Objective</h1>
              <p>
                Integrate into Xeni´s flight domain the seat map of the selected itinerary by the
                user.{' '}
              </p>
              <p>This is a disadvantage of the product against other similar applications. </p>
              <hr />
              <p></p>
              <div className="plugin_pagetree">
                ...
                <fieldset className="hidden">
                  ...
                  />
                  <input type="hidden" name="treePageId" defaultValue={585433090} />
                  <input type="hidden" name="noRoot" defaultValue="false" />
                  <input type="hidden" name="rootPageId" defaultValue={585433090} />
                  ...
                  <fieldset className="hidden">
                    <input type="hidden" name="ancestorId" defaultValue={585433090} />
                  </fieldset>
                </fieldset>
              </div>
              <p />
